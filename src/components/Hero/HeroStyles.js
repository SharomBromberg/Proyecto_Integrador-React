...
import { breakpoints } from "../UI/Breakpoints/breakpoints.js"; // Asegúrate de importar correctamente los breakpoints
...
export const VideoBackgroundStyled = styled.video`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
